...
// MOD #include "SDL2_rotozoom.h"
// MOD #include "SDL2_gfxPrimitives_font.h"
...
// MOD static const unsigned char *currentFontdata = gfxPrimitivesFontdata;
...
void gfxPrimitivesSetFont(const void *fontdata, Uint32 cw, Uint32 ch)
{
        ...
        if ((fontdata) && (cw) && (ch)) {
        	// MOD currentFontdata = (unsigned char *)fontdata;
                charWidth = cw;
                charHeight = ch;
        } else {
        	// MOD currentFontdata = gfxPrimitivesFontdata;
                charWidth = 8;
                charHeight = 8;
        }
        ...
        */
        if (gfxPrimitivesFont[ci] == NULL) {
                ...
                */
                ...
                // MOD charpos = currentFontdata + ci * charSize;
                ...
                */
                ...
                if (charRotation>0)
                {
                	// MOD rotatedCharacter = rotateSurface90Degrees(character, charRotation);
